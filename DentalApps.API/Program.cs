using System.Text;
using DentalApps.API.DAL.Employees;
using DentalApps.API.DAL.Interface;
using DentalApps.API.DAL.Patients;
...
builder.Services.AddScoped<IPatients,PatientsDAL>();
builder.Services.AddScoped<IEmployees,EmployeesDAL>();
